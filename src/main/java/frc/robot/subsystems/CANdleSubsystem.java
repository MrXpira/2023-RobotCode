...
public class CANdleSubsystem extends SubsystemBase {
    ...
    public Command setColors() {
        ...
        return this.run(() -> m_candle.setLEDs(255,255,255));
    }

    public Command fireAnim() {
        System.out.println("Changed fire");
        return this.run(() -> m_candle.animate(new FireAnimation()));
    }
    ...
    //         }
    //     }
    //System.out.println("Current" + m_candle.setLEDs(255, 255, 255));
    }
